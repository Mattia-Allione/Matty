...
model.CapitalCost = Param(model.REGION, model.TECHNOLOGY, model.YEAR, default=0.001)
model.VariableCost = Param(model.REGION, model.TECHNOLOGY, model.MODE_OF_OPERATION, model.YEAR, default=0.00001)
model.FixedCost = Param(model.REGION, model.TECHNOLOGY, model.YEAR, default=0.001)
...
model.StorageLowerLimit_rule = Constraint(model.REGION, model.STORAGE, model.YEAR, rule=StorageLowerLimit_rule)
